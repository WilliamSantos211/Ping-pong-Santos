class Cpu {
    constructor(c, bola) {
        ...
        this.bale = new Image ();
        this.bale.width = 100;
        this.bale.height = 100;
        this.bale.src = "assets/bale.png";
        this.bale.addEventListener('load', () => {
            this.draw()
        });
    }
    ...
    management() {
        ...
        draw(){
            this.management();
            this.c.drawImage(this.bale, 910, this.y, this.bale.width, this.bale.height);
